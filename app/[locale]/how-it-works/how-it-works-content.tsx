...
export function HowItWorksContent() {
  ...
  const steps: Step[] = isEn
    ? [
        ['1', 'Mint and public allocations', 'After the devnet rehearsal, the fixed SEON supply is created. Mint and freeze authorities are revoked, and the reward, Genesis and developer allocations are transferred to published addresses.', Coins],
        ['2', 'Reproducible Genesis Airdrop', 'A public snapshot, ruleset and future seed select 440 independent Solana wallets. Ten weekly waves transfer 10,000 SEON directly to 44 wallets each. Recipients never connect, sign or pay.', Gift],
        ...
        ['4', 'Independent DEX price discovery', 'A verified permissionless SEON/USDC order book may begin empty. Soleon places no controlled initial orders; independent participants determine whether a market, price and liquidity develop.', Landmark],
        ['5', 'Final immutability', 'After wave 10 and the final audit, critical staking authorities are revoked. No official pool or liquidity commitment is planned.', ShieldCheck],
      ]
    : [
        ['1', 'Mint y asignaciones públicas', 'Tras el rehearsal en devnet se crea el supply fijo de SEON. Se revocan mint y freeze authority, y las asignaciones de rewards, Genesis y desarrollador se transfieren a direcciones publicadas.', Coins],
        ['2', 'Airdrop Genesis reproducible', 'Un snapshot, reglas públicas y una seed futura seleccionan 440 wallets independientes de Solana. Diez olas semanales transfieren 10,000 SEON directamente a 44 wallets cada una. Los receptores nunca conectan, firman ni pagan.', Gift],
        ...
        ['4', 'Descubrimiento independiente de precio DEX', 'Un order book permissionless y verificado de SEON/USDC puede comenzar vacío. Soleon no coloca órdenes iniciales controladas; los participantes independientes determinan si surgen mercado, precio y liquidez.', Landmark],
        ['5', 'Inmutabilidad final', 'Tras la ola 10 y la auditoría final se revocan las autoridades críticas del staking. No se planifica un pool oficial ni un compromiso de liquidez.', ShieldCheck],
      ];
