...
const phases = [
  {
    ...
    items: [
      ...
      'Ejecutar rehearsal completo en devnet: mint, tres asignaciones, staking, mantenimiento y airdrop.',
    ...
    itemsEn: [
      ...
      'Run the complete devnet rehearsal: mint, three allocations, staking, maintenance and airdrop.',
  ...
  },
  {
    ...
    items: [
      ...
      'Asignar 440,000,000 SEON a rewards, 4,400,000 a Genesis y 44,444 al desarrollador.',
      'Publicar mint, wallets, token accounts, balances y hashes de configuración.',
      'Fijar el snapshot y preparar la selección determinista de 440 wallets independientes.',
    ],
    itemsEn: [
      ...
      'Allocate 440,000,000 SEON to rewards, 4,400,000 to Genesis and 44,444 to the developer.',
      'Publish the mint, wallets, token accounts, balances and configuration hashes.',
      'Fix the snapshot and prepare deterministic selection of 440 independent wallets.',
    ],
  },
  {
    key: 'phase_2',
    ...
    items: [
      ...
      'Ejecutar la ola 1: 44 wallets x 10,000 SEON y publicar su informe verificable.',
    ...
    itemsEn: [
      ...
      'Execute wave 1: 44 wallets x 10,000 SEON and publish its verifiable report.',
  ...
  },
  {
    ...
    items: [
      'Ejecutar una ola semanal de 44 wallets hasta completar 440 receptores y 4,400,000 SEON.',
      'Publicar por ola receptores, firmas, fallos, reintentos e informe acumulado.',
      'Publicar el order book permissionless SEON/USDC en Manifest una vez verificada su dirección; puede comenzar vacío.',
    ...
    itemsEn: [
      'Execute one weekly wave of 44 wallets until 440 recipients and 4,400,000 SEON are complete.',
      'Publish recipients, signatures, failures, retries and the cumulative report for every wave.',
      'Publish the permissionless SEON/USDC order book on Manifest after verifying its address; it may begin empty.',
  ...
  },
  {
    ...
    days: 'Desde el 2 de noviembre de 2026',
    daysEn: 'From November 2, 2026',
    icon: ShieldCheck,
    color: 'text-primary',
    bgColor: 'bg-primary/10',
    items: [
      'Verificar las diez olas y publicar el informe acumulado de las 440 distribuciones Genesis.',
      'Cerrar únicamente las correcciones técnicas confirmadas durante la ventana pública de lanzamiento.',
      'Completar la auditoría final y revocar las autoridades críticas del staking.',
      'Mantener publicada la dirección verificada de Manifest y distinguir claramente los mercados independientes, débiles, de alto riesgo o falsos.',
      'No reservar SEON para mercado, colocar órdenes iniciales controladas ni prometer liquidez oficial.',
      'Completar la auditoría final y revocar las autoridades críticas del staking después de cerrar correcciones verificadas.',
    ],
    itemsEn: [
      'Verify all ten waves and publish the cumulative report covering all 440 Genesis distributions.',
      'Close only confirmed technical corrections from the public launch window.',
      'Complete the final audit and revoke critical staking authorities.',
      'Keep the verified Manifest address published and clearly distinguish independent, weak, high-risk and fake markets.',
      'Reserve no SEON for market activity, place no controlled initial orders and promise no official liquidity.',
    ],
  },
] as const;
