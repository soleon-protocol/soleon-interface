...
const phases = [
  ...
  },
  {
    ...
    days: '2-24 noviembre 2026',
    daysEn: 'November 2-24, 2026',
    icon: ShieldCheck,
    color: 'text-primary',
    bgColor: 'bg-primary/10',
    items: [
      'El 2 de noviembre, verificar las diez olas, publicar el informe acumulado y presentar la primera propuesta exacta de pool.',
      ...
      'Exigir 1,000,000 SEON de quorum, 66.67% YES, 50 wallets distintas y 25 receptores Genesis; publicar recuento y ventana de comprobación.',
      'Si se aprueba, crear el pool en un máximo de 7 días con la proporción votada y LP permanentemente bloqueado; si falla, esperar al menos 30 días.',
    ...
    itemsEn: [
      'On November 2, verify all ten waves, publish the cumulative report and present the first exact pool proposal.',
      ...
      'If approved, create the pool within 7 days using the voted ratio and a permanently locked LP; if it fails, wait at least 30 days.',
